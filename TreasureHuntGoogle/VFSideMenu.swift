...
public class VFSideMenu : NSObject {
    ...
    private let menuPosition:VFSideMenuPosition = .Left
    ...
    public init(sourceView: UIView, menuPosition: VFSideMenuPosition) {
        super.init()
    ...
    public convenience init(sourceView: UIView, menuTableViewController: UITableViewController, menuPosition: VFSideMenuPosition) {
