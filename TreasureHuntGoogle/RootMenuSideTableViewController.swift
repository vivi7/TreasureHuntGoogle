...
//    var namesControllers : Dictionary<Int,[String]> = [
//        0: ["Clue", "ClueViewController"],
//        1: ["List clues", "ListClueViewController"],
//        2: ["Classification", "FaqViewController"],
//        3: ["About", "InfoViewController"]
//    ]
    
    var namesControllersArr : Dictionary<String,String> = [
        "ClueViewController" : "Clue",
        "ListClueViewController" : "List clues",
        "FaqViewController" : "Classification",
        "InfoViewController" : "About"
    ]
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return namesControllersArr.count
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell!.textLabel?.text = namesControllersArr.values.array[indexPath.row]
...
//            break
//        }
        destViewController = mainStoryboard.instantiateViewControllerWithIdentifier(namesControllersArr.keys.array[indexPath.row]) as UIViewController
